angular.module('geospatial', [
	...
	.constant('policies',{
		...
		'/search': {
			templateUrl: 'angular/templates/search/search-main.html',
		...
		'/websites/:user/:repo': {
			templateUrl: 'websites/:user/:repo/index.html',
			controller: 'RepoContentController'
		},
		'/profile/import/:user/:repo': {
			templateUrl: 'angular/templates/repository/repo-content.html',
			controller: 'RepoContentController'
		}
